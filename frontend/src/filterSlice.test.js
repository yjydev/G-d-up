...
describe('filter Reducers', () => {
  ...
  it('should change category when action is: changeCategoryFilter', () => {
  ...
  it('should change isUsername when action is: changeIsUserItemFilter', () => {
  ...
  it('sshould change selectedSeason when action is: changeSeasonFilter', () => {
...
it('should change selectedColors when action is: changeSeasonFilter', () => {
...
it('should add custom element when action is: addCustomFilter', () => {
...
it('should delete custom element when action is: deleteCustomFilter', () => {
